classdef tracker < handle
  ...
  %   
  % Example use:
  % my_tracker=tracker('cvcc',[0;0;0;0],eye(4),1,0.2,'butter')
  %   
  ...
  % estimated_trajectory=my_tracker.getTraj();
    ...
    methods
        function obj = tracker(opt,x0,p0,sample_freq,cutoffFreq_movAvgOrder,smoothingType_)
            ...
            %For KF constant velocity, cartesian coordinates
            tau = 1/sample_freq;
            if strcmp(opt,'cvcc')
            ...
            elseif strcmp(opt,'ekfctcc') %For EKF, coordinated turn
            ...
            %initiate the trajectory object, and set the type of tracker.
        ...
        %to add new data. Performs both time and measurement update.
        ...
        %getter for the estimated trajectory.
       ...
       %getter for velocity estimates
        ...
        function obj=resetTrajectory(obj)
            obj.trj=obj.trj.reset_Trajectory();
        end
    end
end
